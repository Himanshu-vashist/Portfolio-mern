...
import "./Projects.css";
import { FaGithub, FaExternalLinkAlt, FaPlay, FaGooglePlay, FaCode, FaStar } from "react-icons/fa";
import { Fade } from "../../components/Animation/AnimationWrapper";
  ...
  const projectsData = [
    {
      ...
      subtitle: "Educational Mobile Learning Platform",
      category: "mobile",
      featured: true,
      description: "A comprehensive educational mobile application that makes learning engaging and interactive for users of all ages. Features 10+ educational chapters with gamified learning.",
      image: "knowledge-bubble.png",
      technologies: ["React Native", "TypeScript", "Firebase", "Android Studio", "Xcode"],
      features: [
        "Interactive Chapter System with 10+ educational topics",
    ...
    },
    {
      ...
      subtitle: "Agriculture App",
      category: "mobile",
      featured: false,
      description: "An innovative mobile application designed to assist farmers with modern agricultural techniques.",
      image: "farmer-assistant.png",
      technologies: ["React Native", "Node.js", "Express", "MongoDB"],
      githubUrl: null,
    },
